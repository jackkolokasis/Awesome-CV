...
%---------------------------------------------------------
  \cventry
    ...
    {}
    {}
	{\textbf{Iacovos G. Kolokasis}, Kwstantinos Delis, Shoaib Akram,
    Foivos Zakkak, Polyvios Pratikakis, and Angelos Bilas.  Don’t Scan If You Can Estimate! Efficient Space Reclamation in Tiered Managed Heaps (Under submission to
    HotStorage'25).}
  {}
%---------------------------------------------------------
  \cventry
    ...
    {}
    {}
	{\textbf{Iacovos G. Kolokasis}, Shoaib Akram,
    Foivos Zakkak, Polyvios Pratikakis, and Angelos Bilas. FlexMem: Adaptive
    DRAM Partitioning Between Managed Heap and Page Cache. (Under submission to
    Usenix ATC'25).}
  {}
  \cventry
    {}
